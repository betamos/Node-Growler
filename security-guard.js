 ...
 *
 * @param {string} hashAlg Algorithm for hashing.
 *   Should be 'MD5', 'SHA1', 'SHA256' or 'SHA512'.
 *
 * @param {string|null} encAlg Encryption algorithm. Should be 'AES' or 'DES'
 *   or null if no encryption should be enabled.
 */
